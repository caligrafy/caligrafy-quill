...
$serverName = getenv(SANDBOX_SERVER)?? (isset($_SERVER['SERVER_NAME'])? $_SERVER['SERVER_NAME'] : '');
$port =  getenv(SANDBOX_PORT)?? (isset($_SERVER['SERVER_PORT']) && ':'.$_SERVER['SERVER_PORT'] != '80'  ? ':'.$_SERVER['SERVER_PORT'] : '');
